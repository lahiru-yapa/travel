        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-3 col-xs-6">
                ...
                <ul id='top-menu' class='dropdown-content top-menu-sty'>
                    ...
                    <li><a href="#" class="waves-effect"><i class="fa fa-undo" aria-hidden="true"></i> Backup
                            Data</a>
                    </li>
                    <li class="divider"></li>
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-picture-o"
                                    aria-hidden="true"></i> Sight Seeings</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-braille"
                                    aria-hidden="true"></i> Ui-Kits</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-tags"
                                    aria-hidden="true"></i> Offers</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-ticket"
                                    aria-hidden="true"></i> Booking & Enquiry</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-rss"
                                    aria-hidden="true"></i> Blog & Articals</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                        ...
                        <li><a href="login.html" target="_blank"><i class="fa fa-sign-in" aria-hidden="true"></i>
                                Login</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    ...
                                    <a class='dropdown-button drop-down-meta' href='#'
                        ...
                        <div class="col-md-6">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    ...
                                    <p>Airtport Hotels The Right Way To Start A Short Break Holiday</p>
                                    <a class='dropdown-button drop-down-meta' href='#'
                                        data-activates='dropdown2'><i class="material-icons">more_vert</i></a>
                                    <!-- Dropdown Structure -->
                        ...
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    ...
                                    <p>Airtport Hotels The Right Way To Start A Short Break Holiday</p>
                                    <a class="dropdown-button drop-down-meta" href="#"
                                        data-activates="dr-users"><i class="material-icons">more_vert</i></a>
                                    ...
                                    <div class="table-responsive table-desi">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><span class="list-img"><img src="images/user/3.png"
                                                                alt=""></span>
                                                    </td>
                                                    <td><a href="#"><span class="list-enq-name">Marsha
                                                                Hogan</span><span class="list-enq-city">Illunois,
                        ...
                        <div class="col-md-6">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    ...
                                    <p>Airtport Hotels The Right Way To Start A Short Break Holiday</p>
                                    <a class="dropdown-button drop-down-meta" href="#"
                                        data-activates="dr-listings"><i class="material-icons">more_vert</i></a>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><span class="list-img"><img src="images/listing/1.jpeg"
                                                                alt=""></span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="list-img"><img src="images/listing/2.jpeg"
                                                                alt=""></span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="list-img"><img src="images/listing/4.jpeg"
                                                                alt=""></span>
                                                    </td>
                        ...
                        <div class="col-md-6">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    ...
                                    <p>Airtport Hotels The Right Way To Start A Short Break Holiday</p>
                                    <a class="dropdown-button drop-down-meta" href="#"
                                        data-activates="dr-hotel"><i class="material-icons">more_vert</i></a>
                        ...
                        <div class="col-md-6">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    ...
                                    <p>Airtport Hotels The Right Way To Start A Short Break Holiday</p>
                                    <a class="dropdown-button drop-down-meta" href="#"
                                        data-activates="dr-activ"><i class="material-icons">more_vert</i></a>
                        ...
                        <div class="col-md-6">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    ...
                                    <p>Airtport Hotels The Right Way To Start A Short Break Holiday</p>
                                    <a class="dropdown-button drop-down-meta" href="#"
                                        data-activates="dr-social"><i class="material-icons">more_vert</i></a>
                        ...
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    ...
                                    <p>Airtport Hotels The Right Way To Start A Short Break Holiday</p>
                                    <a class="dropdown-button drop-down-meta" href="#"
                                        data-activates="dr-map"><i class="material-icons">more_vert</i></a>
